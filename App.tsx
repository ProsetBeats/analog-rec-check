  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-[#050505]">
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div className="absolute -left-12 top-0 bottom-0 w-12 bg-[#1a1a1a] border-r-4 border-black flex flex-col justify-around items-center py-10 shadow-2xl">
          <div className="w-5 h-5 rounded-full bg-[#000] shadow-inner border border-white/5" />
          <div className="w-5 h-5 rounded-full bg-[#000] shadow-inner border border-white/5" />
        </div>
        <div className="absolute -right-12 top-0 bottom-0 w-12 bg-[#1a1a1a] border-l-4 border-black flex flex-col justify-around items-center py-10 shadow-2xl">
          <div className="w-5 h-5 rounded-full bg-[#000] shadow-inner border border-white/5" />
          <div className="w-5 h-5 rounded-full bg-[#000] shadow-inner border border-white/5" />
        </div>
        ...
        <div className="relative bg-[#222222] p-12 rounded-sm shadow-[0_60px_100px_rgba(0,0,0,0.9),inset_0_1px_1px_rgba(255,255,255,0.1)] border-b-8 border-black overflow-hidden">
          ...
          <div className="relative flex justify-between items-center mb-16 border-b border-black/40 pb-10">
            ...
            <div className="relative w-40 h-24 bg-[#e8e4d8] rounded-md border-4 border-zinc-900 shadow-[inset_0_4px_12px_rgba(0,0,0,0.3)] overflow-hidden">
              ...
              {/* Needle */}
              <div 
                className="absolute bottom-[-10px] left-1/2 w-0.5 h-20 bg-red-600 origin-bottom transition-transform duration-1000 ease-out z-20"
          ...
          <div className="relative">
            ...
            `}>
              ...
              <div className="absolute right-6 space-y-1">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className="w-12 h-1 bg-black rounded-full shadow-inner" />
                ))}
              </div>
